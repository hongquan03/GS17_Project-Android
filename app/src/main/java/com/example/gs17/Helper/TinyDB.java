...
public class TinyDB {
    ...
    /**
     * Trả về đường dẫn chuỗi của hình ảnh được lưu gần đây nhất.
     * @return đường dẫn chuỗi của hình ảnh được lưu gần đây nhất
     */
     ...
     * @param theFolder đường dẫn thư mục mà bạn muốn lưu hình ảnh, ví dụ như "DropBox/WorkImages"
     * @param theImageName tên mà bạn muốn gán cho tệp hình ảnh, ví dụ như "MeAtLunch.png"
     * @param theBitmap hình ảnh mà bạn muốn lưu dưới dạng Bitmap
     ...
     * @param fullPath đường dẫn đầy đủ của tệp hình ảnh, ví dụ như "Images/MeAtLunch.png"
     * @param theBitmap hình ảnh mà bạn muốn lưu dưới dạng Bitmap
     * @return true nếu hình ảnh được lưu thành công, false nếu không
     */
     ...
     * @return đường dẫn đầy đủ của hình ảnh. Nếu không thành công trong việc tạo thư mục, trả về chuỗi rỗng
     */
    ...
    /**
     * Lấy giá trị int từ SharedPreferences với 'key'. Nếu không tìm thấy key, trả về 0
    ...
    /**
     * Lấy ArrayList đã được parse từ Integers từ SharedPreferences với 'key'
     *@param key key của SharedPreferences
    ...
    /**
     Lấy giá trị long từ SharedPreferences với 'key'. Nếu không tìm thấy key, trả về 0.
     @param key key của SharedPreferences
